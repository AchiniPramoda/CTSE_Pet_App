...
class InsertDogsFood extends StatefulWidget {
  const InsertDogsFood({Key? key}) : super(key: key);
  

  @override
  State<InsertDogsFood> createState() => _InsertDogsFoodState();
}

class _InsertDogsFoodState extends State<InsertDogsFood> {

    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('Foods');
             ...
             SizedBox(
              ...
              SizedBox(
               ...
               RoundButton(title: 'Submit', loading: loading,
                    ...
                    firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance.ref('/Food_images/'+DateTime.now().millisecondsSinceEpoch.toString());
                    ...
                    databaseRef.child(id)
                        ...
                        .set({
                           ...
                           'name': nameController.text.toString(),
                            'foodDetails': foodDetailsController.text.toString(),
                            'catgory': catgoryController.text.toString(),
                      ...
                      toastMessage ('Food Added Successfully');
                      Navigator.push(
                                context,
                                MaterialPageRoute(
                      ...
                      toastMessage ('Food Added Failed');
                           setState(() {
                            loading = false ;
                           });
